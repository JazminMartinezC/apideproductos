...
export class UserListComponent implements OnInit, AfterViewInit {
  ...
  loadData(): void {
      ...
      this.userService.getNews().subscribe((data) => {
        ...
        this.displayedColumns = ['id', 'title', 'image', 'info', 'edit', 'delete'];
       });
  ...
  showInfoModal(row: any): void {
    ...
    Swal.fire({
      ...
      imageUrl:row.category.image,
      imageHeight:180,
      imageWidth:250,
      html: `<strong>Autor:</strong> ${row.price || 'N/A'}<br>
  ...
  showEditModal(row: any): void {
    Swal.fire({
      ...
      html: `<label for="edit-title">Título</label><br>
             ...
             <label for="edit-price">Precio</label><br>
             <input id="edit-price" class="swal2-input" value="${row.price}">`,
